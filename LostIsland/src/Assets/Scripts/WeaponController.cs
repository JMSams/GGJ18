...
namespace FallingSloth.GGJ18
{
    public class WeaponController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            ammoBar.maxValue = ammoBar.currentValue = currentWeapon.roundsPerClip;
        }
        ...
        void Update()
        {
            ...
            {
                ammoBar.currentValue = currentWeapon.currentRounds = currentWeapon.roundsPerClip;
                isReloading = false;
            }
        ...
        void Fire(Vector2 mousePosition)
        {
            ...
            if (Physics.Raycast(hitPos, Vector3.forward, out hit, 200f))
            {
                ...
                {
                    hit.transform.parent.GetComponent<Enemy>().Hit(currentWeapon.damagePerRound, hitPos);
                }
            }
        }
    }
